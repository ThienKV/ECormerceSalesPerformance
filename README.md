...
Mặc dù doanh thu giảm từ **272.7K** xuống **158.8K**, số lượng bán giảm từ **3.6K** xuống **2.0K** và số đơn hàng giảm từ **327** xuống **173**, lợi nhuận lại tăng mạnh từ **-1.8K** lên **25.8K**.

Đồng thời, **AOV** tăng từ **833.95** lên **917.92** và **% Margin** cải thiện từ **-0.7%** lên **16.2%**.
